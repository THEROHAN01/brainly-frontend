            ...
            <section className="relative pt-32 pb-20 px-4 sm:px-6 lg:px-8 overflow-hidden">
                ...
                <div className="max-w-7xl mx-auto relative z-10">
                    <div className="text-center max-w-4xl mx-auto">
                        {/* Badge */}
                        <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-brand-primary/30 mb-8 animate-fade-in badge-shimmer animate-border-glow">
                        ...
                        {/* Subheadline */}
                        <p className="text-xl sm:text-2xl text-brand-text/60 mb-10 max-w-2xl mx-auto animate-fade-in-up delay-100">
                        ...
                        {/* Trust Indicators */}
                        <div className="flex flex-wrap justify-center gap-8 mt-12 text-brand-text/50 text-sm animate-fade-in delay-300">
                ...
                <div className="max-w-7xl mx-auto">
                    ...
                    <div className="flex flex-wrap justify-center items-center gap-8 md:gap-16">
                        {["TechCorp", "DataFlow", "CloudBase", "InnovateLab", "StartupX", "ScaleUp"].map((company) => (
                            <div
                                key={company}
                                className="text-brand-text/30 hover:text-brand-text/60 transition-colors text-xl font-bold tracking-wide"
                            >
                                {company}
                            </div>
                        ))}
            ...
            <section id="features" className="py-24 px-4 sm:px-6 lg:px-8">
                <div className="max-w-7xl mx-auto">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        ...
                        <div className="lg:col-span-2 group relative rounded-3xl border border-brand-surface bg-gradient-to-br from-brand-surface-dark to-brand-bg p-8 hover:border-brand-primary/50 transition-all duration-500 overflow-hidden">
                        ...
                        <div className="group relative rounded-3xl border border-brand-surface bg-gradient-to-br from-brand-surface-dark to-brand-bg p-8 hover:border-brand-primary/50 transition-all duration-500">
                            <div className="w-14 h-14 rounded-2xl bg-brand-primary/10 flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-300">
            ...
            <section id="testimonials" className="py-24 px-4 sm:px-6 lg:px-8">
                <div className="max-w-7xl mx-auto">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                        {/* Testimonial 1 */}
                        <div className="rounded-2xl border border-brand-surface bg-brand-surface-dark/50 p-8 hover:border-brand-primary/30 transition-colors">
